 ...
 * 请求型接口的基类
 */
class Wxpay_client_pub extends Pay_Wechat_Helper 
{
 ...
 * 响应型接口基类
 */
class Wxpay_server_pub extends Pay_Wechat_Helper 
{
 ...
 * 静态链接二维码
 */
class NativeLink_pub  extends Pay_Wechat_Helper
{
...
* JSAPI支付——H5网页端调起支付接口
*/
class JsApi_pub extends Pay_Wechat_Helper
{
